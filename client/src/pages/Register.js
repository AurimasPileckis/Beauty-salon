        ...
        <>
            ...
            <form onSubmit={handleSubmit}>
                <div className="form-group mb-2">
                    ...
                    <input type="text" name="first_name" className="form-control" onChange={handleForm} placeholder="Vardenis"/>
                </div>
                <div className="form-group mb-2">
                <label className="mb-1">Pavardė:</label>
                    <input type="text" name="last_name" className="form-control" onChange={handleForm} placeholder="Pavardenis" />
                </div>
                <div className="form-group mb-2">
                    <label className="mb-1">El. pašto adresas:</label>
                    <input type="email" name="email" className="form-control" onChange={handleForm} placeholder="vardenis.pavardenis@gmail.com" />
                </div>
